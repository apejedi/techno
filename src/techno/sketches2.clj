...
(def house3
  {:tempo 120
   ...
   :drum2 (let []
            (drum-p2
             [:Kit7-Electro]
             [[(drum-s [:Kit7-Electro] :kick3) []] :03 [(drum-s [:Kit7-Electro] :kick3) []] :|
              [o-snr []] :05 [o-snr []]                                                     :|
              :04 [o-snr []]                                                                :|
              :|
              ]
  ...
  {:tempo 120
      :harmony (merge
             (p/phrase-p
              ...
              1/4 32 [:t 4.5 :lsf 400 :ldb -18])
             {:fx {:low [p/p-low-shelf :freq 200 :db -18]}})

   :motif (p/phrase-p
           prophet
           [[:E3 :B3] [:A3 :F3] :34]
           1/4 32 [:decay 5 :amp 0.4 :detune 4])
   :harmony2 (merge
             (p/phrase-p
              rise-pad
              [[:C3 :G3 :E3 :B3] [:F3 :C4 :A3 :E4] :34]
              1/4 32 [:t 7 :lsf 400 :ldb -18])
             {:fx {:low [p/p-low-shelf :freq 200 :db -18]}})

   :motif2 (p/phrase-p
           prophet
           [[:E3 :B3] [:A3 :F3] :34]
           1/4 32 [:decay 6 :amp 0.4 :detune 4])
   :bass (merge
          (p/phrase-p
           prophet2
                                        ;plk-bass
           [:E3 [:cutoff 600] :E3 :E3 :E3  :|
            ...
            :E3 :E3 :E3 :E3                :|
            :E3 :E3 :E3 :E3                :|
            :E3 :E3 :D3 [:cutoff 800] :D3  :|
            :D3 :D3 :D3 :D3                :|
            :D3 :D3 :D3 :D3                :|
            :D3 :D3 :D3 :D3                :|
            :D3 :D3 :F3 [:cutoff 1000] :F3 :|
            :F3 :F3 :F3 :F3                :|
            :F3 :F3 :F3 :F3                :|
            :F3 :F3 :F3 :F3                :|
            :F3 :F3 :F3 :F3                :|]
   ...
   :bass2 (merge
           (p/phrase-p
            ...
            [nil  :E3 [:cutoff 1000] :E3 :|
             ...
             nil :E3 :E3                 :|
             nil :E3 :E3 :E3             :|
             nil :E3 :D3 [:cutoff 1300]  :|
             nil :D3 :D3 :D3             :|
             nil :D3 :D3                 :|
             nil :D3 :D3 :D3             :|
             nil :D3 :F3 [:cutoff 2000]  :|
             nil :F3 :F3 :F3             :|
             nil :F3 :F3                 :|
             nil :F3 :F3 :F3             :|
             nil :F3 :F3                 :|]
   ...
   :test (p/phrase-p
          ...
          1/16 0 [:amp 1.0 :cutoff 1500.0 :rq 0.3 :attack 0.01 :decay 0.7 ])
   })
  ...
  {:tempo 83
   ...
   :bass2 (merge
           (p/phrase-p
            pulsePad
            [[:2 :5<] :|
             :04 [:5< [:gate 0]] [:2 [:gate 0]] :01 [:1 :4<] :|
             :|
             :06 [:1 [:gate 0]] [:4< [:gate 0]] :|
             :02 [:3 :6<] :|
             :|
             :01 [:6< [:gate 0] :3 [:gate 0]] :03 [:3< :7<] :|
             :|
             :03 [:7< [:gate 0] :3< [:gate 0]] :03 [:2 :5<] :|
             :|
             :07 [:2 [:gate 0] :5< [:gate 0]]]
  ...
  {:tempo 120
   ...
   :harmony2 (p/scale-p
              ...
              [[:5 :2]                                           :|
               :|
               :07 [:2 [:gate 0]]                                :|
               :3 :01 [:5 [:gate 0]] :02 [:3 [:gate 0]]          :|
               [:2 :5]                                           :|
               :|
               :|
               [:2 [:gate 0] :5 [:gate 0] :3] :03 [:3 [:gate 0]] :|
               [:2 :5]                                           :|
               :|
               :07 [:2 [:gate 0]]                                :|
               [:5 [:gate 0] :6>]                                :|
               :5> [:6> [:gate 0]] :05 [:5> [:gate 0]]           :|
               :3>                                               :|
               [:3> [:gate 0] :2>]                               :|
               [:2> [:gate 0] :1>]                               :|
               [:1> [:gate 0] :2> :5>]                           :|
               ...
               :|
               :|
               :07 [:5> [:gate 0] :2> [:gate 0] {:release 3}]    :|
               :|
               :|
               :|
               :|
              ...
              1/8 0 [:gate 1.0 :cutoff 1000 :cutoff2 1200.0 :fdur 1 :amp 1.0 :attack 0.01 :release 1.5 :decay 0.3 ])
   })
  ...
  {:tempo 120
   ...
   :prophet (p/scale-p
             ...
             [:3< :02 :3< :03 :3<  :|
              ...
              :01 :3 :02 :3 :02 :3 :|
              :02 :3               :|]
             1/8 0 [:atk 2.0 :sus 0.0 :rel 3.0 :c1 1.0 :c2 -1.0 :detune 0.2 :pan 0.0 :cfhzmin 0.1 :cfhzmax 0.3 :cfmin 500.0 :cfmax 2000.0 :rqmin 0.1 :rqmax 0.2 :lsf 200.0 :ldb 0.0 :hsf 6000.0 :hdb 0.0 :amp 1.0 :rs 0.5 ])
   :harmony1 (p/scale-p
              cs80
              :C4 :major
              [:6 :02 :6 :03 :6 :|
...
(def tekno4
  {:tempo 120
   ...
   :lead (p/scale-p
          ...
          1/8 0 [:atk 0.08 :f-dur 0.3 :echo 0 :decay 1.4 :amp 2 :cutoff 3000 :cutoff2 2000.0 ])
